...
//make sure to find that the container has the value specified
...
//Get the number of elements in the container, generate a random number to push forward the iterator
...
//distribution(RandomGeneraterType)
